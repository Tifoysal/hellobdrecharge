                ...
                @endif
                    ...
                    <form action="{{route('service.update',$service->id)}}" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input min="1" step="0.01" type="number" name="rate" class="form-control" value="{{ $service->rate }}"
                        ...
                        <div class="form-group">
                            ...
                            <input step="0.01" type="number" name="commission_discount" class="form-control" value="{{ $service->commission_discount }}"
