...
<div class="form-screen">
    ...
    <a href="index.html" class="spur-logo"><i class="fas fa-mobile"></i> <span>{{config('app.name')}}</span></a>
    ...
    <div class="card account-dialog">
        ...
        @endif
            @if ($errors->any())
                <div class="alert alert-danger" style="padding-bottom: 10px;border-radius: 2px;">
