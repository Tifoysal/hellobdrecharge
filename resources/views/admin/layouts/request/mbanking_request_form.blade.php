            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="content-panel">
                        ...
                        <form action="{{route(auth()->user()->type.'.mBanking.store','mbanking')}}" method="post"
                              role="form">
                            @csrf
                            <label>Enter Account NO * :</label>
                            <input value="{{old('req_mobile')}}" class="form-control" type="number" name="req_mobile"
                                   id="req_mobile" required
                                   placeholder="017XXXXXXXX">


                            <label>Enter Amount * :</label>
                            <input onkeyup="getRate()" value="50" class="form-control" type="number" name="req_amount" id="req_amount"
                                   required
                                   placeholder="Amount" min="50">

<p style="margin-top: 20px; float: right">
    Conversion Rate: €
    <span class="alert alert-success" id="conversion">0</span>
</p>
                            ...
                            <div>
                                ...
                                <button style="margin-top: 25px; float: right" type="button" class="btn btn-primary"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Set Rate</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('rate.store')}}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input id="rate" value="{{$conversion_rate}}" type="number" name="rate" class="form-control" placeholder="Enter rate">
                        </div>
...
@push('javascript')
    <script>
        $(document).ready(function () {
            ...
            if(rate==0)
            {
                document.getElementById("conversion").innerHTML='No rate found.';
            }else {
                document.getElementById("conversion").innerHTML=(amount/rate).toFixed(2);
            }
        });
            function getRate()
            {
